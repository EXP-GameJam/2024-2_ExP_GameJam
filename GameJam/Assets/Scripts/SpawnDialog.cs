...
public class SpawnDialog : MonoBehaviour
{
    ...
    public static DialogSettings[] dialogList =
    {
        ...
        new DialogSettings("헉 헉 미안해!!", SpeechBubbleType.Hard, ColorType.Red),
        new DialogSettings("살려주세요!", SpeechBubbleType.Hard, ColorType.Red),
        new DialogSettings("진짜 죽겠어", SpeechBubbleType.Panic, ColorType.Purple),
        new DialogSettings("다 말할게!!!", SpeechBubbleType.Panic, ColorType.Purple),
